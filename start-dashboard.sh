...
echo ""
echo "========================================================================"
echo "🚀 AROGYAGRID OPERATIONAL DASHBOARD IS LIVE!"
echo "========================================================================"
echo "🌐 Frontend Dashboard: http://localhost:3000/work"
echo "⚙️ Go API Backend:     http://localhost:8085"
echo "📊 Database:           PostgreSQL 16 (arogyagrid)"
echo "------------------------------------------------------------------------"
echo "👥 Team Members & Epics Configured:"
echo "   👑 Sarthak      — Epic 1 (Foundation & Auth) & Epic 5 (Integration)"
echo "   📋 Vaishnavi    — Epic 2 (Core Work Backend & Approvals)"
echo "   🏥 Riya         — Epic 3 (Transitions & Shortage Queues)"
echo "   🚚 Shneanjali   — Epic 4 (Frontend UI & Dispatch Operations)"
echo "------------------------------------------------------------------------"
echo "👉 Open http://localhost:3000/work in your browser to view the dashboard"
echo "   with interactive filters for Epics and Team Members."
echo "------------------------------------------------------------------------"
